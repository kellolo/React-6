...
export const START_CHAT_LOADING = '@@chat/START_LOADING';
export const FAIL_CHAT_LOADING = '@@chat/FAIL_LOADING';
export const SUCCESS_CHAT_LOADING = '@@chat/SUCCESS_LOADING';
